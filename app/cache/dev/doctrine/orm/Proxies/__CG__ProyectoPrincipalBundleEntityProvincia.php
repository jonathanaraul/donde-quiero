 ...
 */
class Provincia extends \Proyecto\PrincipalBundle\Entity\Provincia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'seo', 'iniciales');
    }
